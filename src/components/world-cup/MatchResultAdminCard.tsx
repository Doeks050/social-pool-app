    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-3 transition hover:border-zinc-700">
      ...
      <form action={saveAction} className="mt-3">
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-end gap-2 rounded-xl border border-zinc-800 bg-zinc-950/60 p-3">
          <div>
            ...
            <input
              ...
              className="h-11 w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 text-center text-base font-semibold text-white outline-none transition focus:border-white"
              placeholder="0"
              required
            />
          </div>
        ...
        <div className="mt-3 flex justify-end">
          <button
            type="submit"
            className="rounded-lg bg-white px-4 py-2 text-xs font-semibold text-zinc-950 transition hover:bg-zinc-200"
          >
            Opslaan
          </button>
        </div>
